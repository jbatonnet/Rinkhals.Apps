...
1. Download the `app-tls-addon.swu` file from GitHub Actions.
...
5. Enable the application via the Rinkhals touchscreen interface or by creating the file `/useremain/home/rinkhals/apps/tls-addon.enabled`.
